...
class SearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search" do
    assert_difference('Search.count') do
      post searches_url, params: { search: { location: @search.location, term: @search.term } }
    end
  ...
  test "should update search" do
    patch search_url(@search), params: { search: { location: @search.location, term: @search.term } }
